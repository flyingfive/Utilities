...
namespace FlyingSocket.Client
{
    ...
    public abstract class BaseSocketClient : SocketInvokeElement
    {
        ...
        //        OutgoingDataAssembler.AddCommand(CommandKeys.Active);
        //        SendCommand();
        ...
        //        OutgoingDataAssembler.AddValue(CommandKeys.UserName, userName);
        //        OutgoingDataAssembler.AddValue(CommandKeys.Password, password.MD5());
        //        SendCommand();
        //        var success = ReceiveCommand();
        //        if (success)
        //        {
        ...
        //            {
        //                Disconnect();
        //                return Connect(_hostAddress, _port);
