...
namespace FlyingSocket.Client
{
    ...
    public abstract class ClientSocketInvokeElement
    {
        ...
        public void SendCommand()
        {
            ...
            var cnt = _tcpClient.Client.Send(SendBuffer.Buffer, 0, SendBuffer.DataCount, SocketFlags.None); //使用阻塞模式，Socket会一次发送完所有数据后才返回
        ...
        {
            ReceiveBuffer.Clear();
            _tcpClient.Client.Receive(ReceiveBuffer.Buffer, sizeof(int), SocketFlags.None);
            ...
            _tcpClient.Client.Receive(ReceiveBuffer.Buffer, sizeof(int), packetLength, SocketFlags.None);
