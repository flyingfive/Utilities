...
{
    public class DbValueExpressionVisitor : DbExpressionVisitor<DbExpression>
    {
        private MsSqlGenerator _generator = null;

        public DbValueExpressionVisitor(MsSqlGenerator generator)
        {
            if (generator == null)
        ...
        {
            DbCaseWhenExpression caseWhenExpression = MsSqlGenerator.ConstructReturnCSharpBooleanCaseWhenExpression(exp);
