...
namespace FlyingFive.Utils
{
    ...
    public class ChinesePinYinHelper
    {
        ...
        /// 获取中文拼音首写字母
        /// </summary>
        /// <param name="chineseString">中文汉字内容</param>
        /// <returns></returns>
        public static string ChineseCap(string chineseString)
        {
            if (String.IsNullOrEmpty(chineseString)) return String.Empty;

            var sb = new StringBuilder(chineseString.Length + 1);
            var chs = chineseString.ToCharArray();
        ...
        public static String FullSpell(String str)
        {
        ...
        /// <param name="ch"></param>        
        /// <returns></returns>        
        private static String GetFirst(Char ch)
        {
            var rs = Get(ch);
